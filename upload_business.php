        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h1 class="box-title">Get started analyzing your resumes by uploading a .txt file!</h1>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="list_resumes_business.php" method="post" enctype="multipart/form-data">
              <div class="box-body">
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane" id="control-sidebar-home-tab">
        <h3 class="control-sidebar-heading">Scoring Preferences</h3>
        <label>1 is low preference and 5 is highest preference</label>
