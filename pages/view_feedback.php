...
while($row = mysqli_fetch_row($result))
{
	echo "<form action='interview_details.php' method='post'>";
	echo "<tr id='$row[0]'>";
	...
	echo "<td>";
	echo "<input type='submit' value='View Details' class='btn btn-success' id='$row[0]'>";
	echo "<input name='textfield' type='hidden' value='$row[1]'>";
	echo "</td>";
