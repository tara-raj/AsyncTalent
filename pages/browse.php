    ...
    <div id="wrapper">
       ...
       <!-- Navigation -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Browse Companies</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <select class="form-control" onchange="sort()" id="sortSelect" name="sortSelect">
 			...
 			<!--<p id="demo"></p>--!>
 			<div align="right">
                <input name="Sort" type="submit" value="Sort" class="btn btn-sm btn-success"">
            </div>
 			</form>
 			<script>
 			function sort(){
 				...
 				if(x == 'Overall Rating'){
 					document.getElementById("demo").innerHTML = "You selected: Overall Rating";
 				}
 				else {
 					document.getElementById("demo").innerHTML = "You selected: Something Else";
 				}*/	
 				//}
 			}
 			</script>
			...
			$query= "SELECT * FROM Companies ORDER BY " .  $order;
			$conn->query($query) or die ("couldn't connect " . $conn->error);
			$result = $conn->query($query);
