            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="forms.php"><i class="fa fa-search fa-fw"></i>Find</a>
                        </li>
                        <li>
            ...
            <!-- /.row -->
                        ...
                        <!-- /.panel-body -->
                         <div class="col-lg-6" align="left">
                                    <table align="center">
                                    <tr>
                                    	<img src="http://downgraf.com/wp-content/uploads/2014/09/01-progress.gif" height="200" width="220"></img>
                                    </tr>
                                    <tr>
                                    	<h1> Calculating </h1>
                                    </tr>
                                    ...
                                    <?php
                                    	Header( "refresh:5;url=forms_2.php" );
                                    ?>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                    </div>
