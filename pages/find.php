                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                        <h3 class="text-primary"> Find Companies <h3>
                                        <h4> We have created a recommendation engine for you to find companies that are a good fit for you. 
                                        Proceed to the company finder form to enter your information about your ideal job. 
                                        We then take your criteria and match you to your best fit companies according to your responses.</h4>
                                        <br>
                                        <div align="center">
                                    		<!--<input class="btn btn-primary" type="submit" onclick = 'submitForm()'></input>--!>
                                    		<button type="button" value="Go To Form" onclick="sub();" class="btn btn-lg btn-success"">Go to Form</button>
                                    	</div>
                                    	</form>
                                    	<script>
                                    		function sub(){
