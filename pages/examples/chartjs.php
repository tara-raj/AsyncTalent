...
?>
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="box-header with-border">
          <h3 class="box-title"><b><?php echo $total_logs; ?> Total Logs</b></h3>
        </div>
        <!-- /.box-body -->
      </div>
      <!-- /.box -->
          ...
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">Hunger Level</h3>
...
<!-- page script -->
<script>
var hunger_1 = '<?php echo $hunger_1; ?>';
hunger_1 = parseInt(hunger_1);
var hunger_2 = '<?php echo $hunger_2; ?>';
hunger_2 = parseInt(hunger_2);
var hunger_3 = '<?php echo $hunger_3; ?>';
hunger_3 = parseInt(hunger_3);
var hunger_4 = '<?php echo $hunger_4; ?>';
hunger_4 = parseInt(hunger_4);
var hunger_5 = '<?php echo $hunger_5; ?>';
hunger_5 = parseInt(hunger_5);

var happy = '<?php echo $mood_happy; ?>';
happy = parseInt(happy);
var indifferent = '<?php echo $mood_indifferent; ?>';
indifferent = parseInt(indifferent);
var sad = '<?php echo $mood_sad; ?>';
sad = parseInt(sad);
var angry = '<?php echo $mood_angry; ?>';
angry = parseInt(angry);
var stressed = '<?php echo $mood_stressed; ?>';
stressed = parseInt(stressed);
  ...
  $(function () {
    ...
    var areaChartData = {
      labels: ["7/12/16", "7/13/16", "7/14/16", "7/15/16", "7/16/16", "7/17/16", "7/18/16"],
      datasets: [
        {
          label: "Electronics",
